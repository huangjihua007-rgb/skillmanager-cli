...
// ─── 激活引导 ─────────────────────────────────────
function showActivateGuide(slug) {
  console.log('');
  console.log(`  ${D}───────────────────────────────────────────────────────${X}`);
  console.log(`  ${C}${B}💡 在 Claude / OpenClaw 里激活：${X}`);
...
async function installSkill(skill) {
  ...
  if (method.method === 'git') {
    ...
    showActivateGuide(skill.slug || skill.name);
